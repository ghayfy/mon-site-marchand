...
INSERT INTO `_schema_migrations` VALUES (1,'0001_products_indexes.sql','2025-09-20 08:00:13');
...
CREATE TABLE `cart_items` (
  ...
  CONSTRAINT `cart_items_ibfk_1` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `orders` (
  `id` int NOT NULL AUTO_INCREMENT,
  `total_t_t_c` decimal(10,2) NOT NULL DEFAULT '0.00',
  `currency` varchar(3) NOT NULL DEFAULT 'EUR',
  `status` enum('PENDING','PAID','SHIPPED','CANCELLED') DEFAULT 'PENDING',
  `provider` varchar(40) DEFAULT 'fake',
...
CREATE TABLE `products` (
  ...
  `price_h_t` decimal(10,2) NOT NULL DEFAULT '0.00',
...
INSERT INTO `products` VALUES (1,'Tee-shirt blanc','tee-shirt-blanc','100% coton','TS-BLANC',9.99,20.00,100,0.000,1,'2025-09-20 08:00:12','2025-09-20 08:00:12',NULL),(2,'Mug logo','mug-logo','CÃ©ramique','MUG-LOGO',7.50,20.00,200,0.000,1,'2025-09-20 08:00:12','2025-09-20 08:00:12',NULL),(5,'Sac coton','sac-coton','Tote bag 140g','TOTE-140',3.90,20.00,500,0.000,1,'2025-09-20 08:41:31','2025-09-20 08:41:31',NULL),(6,'Casquette noire','casquette-noire','Coton brossé','CAP-BLK',12.50,20.00,150,0.000,1,'2025-09-20 08:41:31','2025-09-20 08:56:09',NULL);
...
-- Dump completed on 2025-09-20 10:06:52
